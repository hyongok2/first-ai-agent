...
public interface ICapabilitySelectionService
{
    ...
    /// <param name="availableCapabilities">사용 가능한 시스템 능력 목록</param>
    ...
    /// <summary>
    /// 현재 시스템에서 사용 가능한 능력 목록을 반환합니다.
    /// </summary>
    /// <returns>사용 가능한 시스템 능력 목록</returns>
    Task<IReadOnlyList<SystemCapabilityType>> GetAvailableCapabilitiesAsync();
}