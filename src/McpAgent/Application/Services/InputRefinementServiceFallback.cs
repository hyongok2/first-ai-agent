...
/// </summary>
public class InputRefinementServiceFallback : IInputRefinementService
{
    private readonly ILogger<InputRefinementServiceFallback> _logger;
    private readonly ILlmService _llmService;
    private readonly IPromptService _promptService;
    private readonly IRequestResponseLogger _requestResponseLogger;
    private readonly IToolExecutor _toolExecutor;

    public InputRefinementServiceFallback(
        ILogger<InputRefinementServiceFallback> logger, 
